...
void InitADC1(void) {
    ...
    /************************************************************/
    //ADC utilisés : 16(G9)-11(C11)-6(C0)-ANA_3(B1)-ANA_15(E15)
    ANSELBbits.ANSB1 = 1;   //impacte les 5 capteurs
    ANSELCbits.ANSC0 = 1;
    ANSELCbits.ANSC11 = 1;
    ANSELGbits.ANSG9 = 1;
    ANSELEbits.ANSE15 = 1;
    AD1CSSLbits.CSS3 = 1; // Active l'impacte des capteurs, si on met cette ligne à 0 le capteur concerné ne fonctionne plus
    AD1CSSLbits.CSS6 = 1; //
    AD1CSSLbits.CSS11 = 1;//
    AD1CSSHbits.CSS16 = 1;
    AD1CSSLbits.CSS15 = 1;
...
void __attribute__((interrupt, no_auto_psv)) _AD1Interrupt(void) {
    ...
    ADCResult[3] = ADC1BUF1; 
    ADCResult[2] = ADC1BUF2;
    ADCResult[1] = ADC1BUF3;
    ADCResult[0] = ADC1BUF4;
    ADCConversionFinishedFlag = 1;
}

void ADC1StartConversionSequence() {
    AD1CON1bits.SAMP = 1; //Lance une acquisition ADC en mettant le flag à 1
}

unsigned int * ADCGetResult(void) {
    return ADCResult; //tableau d'
}
